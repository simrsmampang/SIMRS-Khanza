...
public class frmUtama extends javax.swing.JFrame {
    ...
    private  String requestJson,URL="",utc="",link="",datajam="",
              ...
              kodepoli="",kodedokter="",kodebpjs=Sequel.cariIsi("select password_asuransi.kd_pj from password_asuransi"), response = "200";
    ...
    private void jam(){
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(jam.equals("01")&&nilai_menit < 5){
                    TeksArea.setText("");
                    date = new Date();  
                    Tanggal1.setText(tanggalFormat.format(date)); 
                    Tanggal2.setText(tanggalFormat.format(date)); 
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                                ...
                                (Tanggal1.getText().equals(Tanggal2.getText()) 
                                    ? "'" + Tanggal1.getText() + "' and date_add('" + Tanggal1.getText() + "', interval 30 day) " 
                        ...
                        try {
                            ...
                            while(rs.next()){
                                try {     
                                    ...
                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "addantrean", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), rs.getString("dt_ed"));
                        ...
                        try {
                            ...
                            while(rs.next()){
                                try {     
                                    ...
                                    nameNode = root.path("metadata");
                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                    Sequel.logTaskid(rs.getString("no_rawat_batal"), rs.getString("nobooking"), "MobileJKN", "batalantrean", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), rs.getString("tanggalbatal"));
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"99",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "99", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if (!nameNode.path("code").asText().equals("200")) {
                        ...
                        ps=koneksi.prepareStatement(
                            "select referensi_mobilejkn_bpjs.nobooking, referensi_mobilejkn_bpjs.no_rawat, referensi_mobilejkn_bpjs.nomorkartu, referensi_mobilejkn_bpjs.nik, referensi_mobilejkn_bpjs.nohp, " +
                            "referensi_mobilejkn_bpjs.kodepoli, poliklinik.nm_poli, referensi_mobilejkn_bpjs.pasienbaru, reg_periksa.no_rkm_medis, pasien.nm_pasien, referensi_mobilejkn_bpjs.tanggalperiksa, " +
                            "referensi_mobilejkn_bpjs.kodedokter, dokter.nm_dokter, referensi_mobilejkn_bpjs.jampraktek, referensi_mobilejkn_bpjs.jeniskunjungan, referensi_mobilejkn_bpjs.nomorreferensi, " +
                            "referensi_mobilejkn_bpjs.nomorantrean, referensi_mobilejkn_bpjs.angkaantrean, referensi_mobilejkn_bpjs.estimasidilayani, referensi_mobilejkn_bpjs.sisakuotajkn, referensi_mobilejkn_bpjs.kuotajkn, " +
                            "referensi_mobilejkn_bpjs.sisakuotanonjkn, referensi_mobilejkn_bpjs.kuotanonjkn, referensi_mobilejkn_bpjs.status, referensi_mobilejkn_bpjs.validasi, " +
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = referensi_mobilejkn_bpjs.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '3'), 'Sudah', '') as ada_task3, " +
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = referensi_mobilejkn_bpjs.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '4'), 'Sudah', '') as ada_task4, " +
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = referensi_mobilejkn_bpjs.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '5'), 'Sudah', '') as ada_task5, " +
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = referensi_mobilejkn_bpjs.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '6'), 'Sudah', '') as ada_task6, " +
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                if(task99.equals("")){
                                    if(task3.equals("")){
                                        datajam=Sequel.cariIsi("select referensi_mobilejkn_bpjs.validasi from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=? and status = 'Checkin'",rs.getString("no_rawat"));
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"3",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "3", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if(!nameNode.path("code").asText().equals("200")){
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"4",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "4", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if(!nameNode.path("code").asText().equals("200")){
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"5",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "5", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if(!nameNode.path("code").asText().equals("200")){
                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='5' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                        task5 = "";
                                                        if (nameNode.path("message").asText().toLowerCase().contains("tidak boleh kurang atau sama dengan waktu sebelumnya")) {
                                                            datajam = Sequel.cariIsi("select concat(tgl_registrasi, ' ', current_time()) from reg_periksa where reg_periksa.stts = 'Sudah' and reg_periksa.no_rawat = ?", rs.getString("no_rawat"));
                                                            if (!datajam.equals("")) {
                                                                if (Sequel.menyimpantfSmc("referensi_mobilejkn_bpjs_taskid", null, rs.getString("no_rawat"), "5", datajam)) {
                                                                    parsedDate = dateFormat.parse(datajam);
                                                                    task5 = "Sudah";
                                                                    try {
                                                                        headers = new HttpHeaders();
                                                        ...
                                                        } else if (nameNode.path("message").asText().contains("TaskId=4 belum ada")) {
                                                            Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid = '4' and no_rawat = '" + rs.getString("no_rawat") + "'");
                                                        }
                                                    }  
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                    ...
                                    if(task5.equals("Sudah") && task6.equals("")){
                                        ...
                                        if(!noresep.equals("")
                                            && !Sequel.cariBooleanSmc("select * from referensi_mobilejkn_bpjs_taskid_response2 "
                                                ...
                                                + "and referensi_mobilejkn_bpjs_taskid_response2.jenispasien = 'MobileJKN' "
                                                + "and referensi_mobilejkn_bpjs_taskid_response2.taskid = 'addantreanfarmasi' "
                                            ...
                                            try {     
                                                ...
                                                nameNode = root.path("metadata");
                                                System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "addantreanfarmasi", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), null);
                                                TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                            }catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : "+ex);
                                            }
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"6",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "6", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if(!nameNode.path("code").asText().equals("200")){
                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='6' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                        task6 = "";
                                                        if (nameNode.path("message").asText().contains("TaskId=5 belum ada")) {
                                                            Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid = '5' and no_rawat = '" + rs.getString("no_rawat") + "'");
                                                        }
                                                    }  
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"7",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                    Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("nobooking"), "MobileJKN", "7", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    if(!nameNode.path("code").asText().equals("200")){
                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='7' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                        task7 = "";
                                                        if (nameNode.path("message").asText().contains("TaskId=6 belum ada")) {
                                                            Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid = '6' and no_rawat = '" + rs.getString("no_rawat") + "'");
                                                        }
                                                    }  
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                        ...
                        //Pasien BPJS Onsite/NonJKN
                        TeksArea.append("Menjalankan WS tambah antrian Mobile JKN Pasien Non BPJS/BJS Onsite\n");
                        ps=koneksi.prepareStatement(
                            "select reg_periksa.no_reg, reg_periksa.no_rawat, reg_periksa.tgl_registrasi, reg_periksa.kd_dokter, dokter.nm_dokter, maping_dokter_dpjpvclaim.kd_dokter_bpjs, maping_dokter_dpjpvclaim.nm_dokter_bpjs, pasien.no_ktp, pasien.no_tlp, " +
                            ...
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = reg_periksa.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '4'), 'Sudah', '') as ada_task4, " +
                            "if(exists(select * from referensi_mobilejkn_bpjs_taskid where referensi_mobilejkn_bpjs_taskid.no_rawat = reg_periksa.no_rawat and referensi_mobilejkn_bpjs_taskid.taskid = '5'), 'Sudah', '') as ada_task5, " +
                            ...
                            "join maping_poli_bpjs on reg_periksa.kd_poli = maping_poli_bpjs.kd_poli_rs join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis where reg_periksa.tgl_registrasi between " +
                            "'" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "' and not exists(select * from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat = reg_periksa.no_rawat) " +
                                ...
                                try {
                                    ...
                                    if(rs2.next()){
                                            ...
                                            if(!datajam.equals("")){
                                                if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"99",datajam})==true){
                                                    ...
                                                    try {     
                                                        ...
                                                        requestEntity = new HttpEntity(requestJson,headers);
                                                        URL = link+"/antrean/updatewaktu";	
                                                        System.out.print("taskid99 " + rs.getString("no_rawat") + " : ");
                                                        root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.POST, requestEntity, String.class).getBody());
                                                        nameNode = root.path("metadata");
                                                        System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                        Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "99", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                        if(!nameNode.path("code").asText().equals("200")){
                                                            Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='99' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                            task99 = "";
                                                        }  
                                        ...
                                        if (task99.equals("")) {
                                            if (task1.equals("")) {
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"1",datajam})==true){
                                                        ...
                                                        task1 = "Sudah";
                                                        try {     
                                                            TeksArea.append("Menjalankan WS taskid mulai tunggu admission Mobile JKN Pasien Non BPJS/BPS Onsite\n");
                                                            headers = new HttpHeaders();
                                                            headers.setContentType(MediaType.APPLICATION_JSON);
                                                            headers.add("x-cons-id",koneksiDB.CONSIDAPIMOBILEJKN());
                                                            utc=String.valueOf(api.GetUTCdatetimeAsString());
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "1", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                            ...
                                            if (task1.equals("Sudah") && task2.equals("")) {
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"2",datajam})==true){
                                                        ...
                                                        task2 = "Sudah";
                                                        try {     
                                                            TeksArea.append("Menjalankan WS taskid mulai pelayanan admission Mobile JKN Pasien Non BPJS/BPS Onsite\n");
                                                            headers = new HttpHeaders();
                                                            headers.setContentType(MediaType.APPLICATION_JSON);
                                                            headers.add("x-cons-id",koneksiDB.CONSIDAPIMOBILEJKN());
                                                            utc=String.valueOf(api.GetUTCdatetimeAsString());
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "2", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                            ...
                                            if(task3.equals("")){
                                                try {     
                                                    datajam = Sequel.cariIsiSmc("select date_add(concat(?, ' ', ?), interval ? * 5 minute)", rs.getString("tgl_registrasi"), rs2.getString("jam_mulai"), String.valueOf(rs.getInt("no_reg")));
                                                    parsedDate = dateFormat.parse(datajam);
                                                    if (!rs.getString("kd_pj").equals(kodebpjs) 
                                                        ...
                                                        requestJson ="{" +
                                                                        ...
                                                                        "\"kodepoli\": \""+rs.getString("kd_poli_bpjs")+"\"," +
                                                                        "\"namapoli\": \""+rs.getString("nm_poli")+"\"," +
                                                                        ...
                                                                        "\"angkaantrean\": "+rs.getInt("no_reg")+"," +
                                                                        "\"estimasidilayani\": "+parsedDate.getTime()+"," +
                                                                        "\"sisakuotajkn\": "+(rs2.getInt("kuota")-rs.getInt("no_reg"))+"," +
                                                                        "\"kuotajkn\": "+rs2.getString("kuota")+"," +
                                                                        "\"sisakuotanonjkn\": "+(rs2.getInt("kuota")-rs.getInt("no_reg"))+"," +
                                                        ...
                                                        System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                        TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                                        Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "addantrean", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                    }
                                                }catch (Exception ex) {
                                                    System.out.println("Notifikasi Bridging : "+ex);
                                                }
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"3",datajam})==true){
                                                        ...
                                                        try {     
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "3", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='3' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                                task3 = "";
                                                            }  
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"4",datajam})==true){
                                                        ...
                                                        try {     
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "4", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='4' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                                task4 = "";
                                                            }   
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"5",datajam})==true){
                                                        ...
                                                        try {     
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "5", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='5' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                                task5 = "";
                                                                if (nameNode.path("message").asText().toLowerCase().contains("tidak boleh kurang atau sama dengan waktu sebelumnya")) {
                                            ...
                                            if(task5.equals("Sudah") && task6.equals("")){
                                                ...
                                                if(!noresep.equals("")
                                                    ...
                                                    try {     
                                                        ...
                                                        nameNode = root.path("metadata");
                                                        System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                        Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "addantreanfarmasi", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), null);
                                                        TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                                    }catch (Exception ex) {
                                                        System.out.println("Notifikasi Bridging : "+ex);
                                                    }
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"6",datajam})==true){
                                                        ...
                                                        try {     
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "6", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='6' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                                task6 = "";
                                                                if (nameNode.path("message").asText().contains("TaskId=5 belum ada")) {
                                                ...
                                                if(!datajam.equals("")){
                                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"7",datajam})==true){
                                                        ...
                                                        try {     
                                                            ...
                                                            nameNode = root.path("metadata");
                                                            System.out.println(nameNode.path("code").asText() + " " + nameNode.path("message").asText());
                                                            Sequel.logTaskid(rs.getString("no_rawat"), rs.getString("no_rawat"), "Onsite", "7", requestJson, nameNode.path("code").asText(), nameNode.path("message").asText(), root.toString(), datajam);
                                                            if(!nameNode.path("code").asText().equals("200")){
                                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='7' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                                task7 = "";
                                                                if (nameNode.path("message").asText().contains("TaskId=6 belum ada")) {
