                ...
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    if(Double.parseDouble(tbBangsal.getValueAt(i,11).toString())>0){
                        if(Sequel.menyimpantf("bayar_pemesanan","?,?,?,?,?,?,?","Data", 7,new String[]{
                            ...
                            Sequel.insertTampJurnal(Bayar_Pemesanan_Obat,"HUTANG USAHA",Double.parseDouble(tabMode.getValueAt(i,11).toString()),0);
                            Sequel.insertTampJurnal(koderekening,AkunBayar.getSelectedItem().toString(),0,Double.parseDouble(tabMode.getValueAt(i,11).toString()));
