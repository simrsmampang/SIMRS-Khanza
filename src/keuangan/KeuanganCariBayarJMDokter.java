                        ...
                        if(rs.next()){
                            ...
                            if(sukses==true){
                                ...
                                if(rs.getDouble("rawatjalan")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Tindakan_Ralan+"','Beban Jasa Medik Dokter Tindakan Ralan','"+rs.getDouble("rawatjalan")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+rs.getDouble("rawatjalan")+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Tindakan_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Tindakan_Ralan+"','Utang Jasa Medik Dokter Tindakan Ralan','0','"+rs.getDouble("rawatjalan")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+rs.getDouble("rawatjalan")+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Tindakan_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("rawatinap")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Tindakan_Ranap+"','Beban Jasa Medik Dokter Tindakan Ranap','"+rs.getDouble("rawatinap")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("rawatinap"))+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Tindakan_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Tindakan_Ranap+"','Utang Jasa Medik Dokter Tindakan Ranap','0','"+rs.getDouble("rawatinap")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("rawatinap"))+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Tindakan_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("labrawatjalan")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Laborat_Ralan+"','Beban Jasa Medik Dokter Laborat Ralan','"+rs.getDouble("labrawatjalan")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("labrawatjalan"))+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Laborat_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Laborat_Ralan+"','Utang Jasa Medik Dokter Laborat Ralan','0','"+rs.getDouble("labrawatjalan")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("labrawatjalan"))+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Laborat_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("labrawatinap")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Laborat_Ranap+"','Beban Jasa Medik Dokter Laborat Ranap','"+rs.getDouble("labrawatinap")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("labrawatinap"))+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Laborat_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Laborat_Ranap+"','Utang Jasa Medik Dokter Laborat Ranap','0','"+rs.getDouble("labrawatinap")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("labrawatinap"))+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Laborat_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("radrawatjalan")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Radiologi_Ralan+"','Beban Jasa Medik Dokter Radiologi Ralan','"+rs.getDouble("radrawatjalan")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("radrawatjalan"))+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Radiologi_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Radiologi_Ralan+"','Utang Jasa Medik Dokter Radiologi Ralan','0','"+rs.getDouble("radrawatjalan")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("radrawatjalan"))+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Radiologi_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("radrawatinap")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Radiologi_Ranap+"','Beban Jasa Medik Dokter Radiologi Ranap','"+rs.getDouble("radrawatinap")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("radrawatinap"))+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Radiologi_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Radiologi_Ranap+"','Utang Jasa Medik Dokter Radiologi Ranap','0','"+rs.getDouble("radrawatinap")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("radrawatinap"))+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Radiologi_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("operasiralan")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Operasi_Ralan+"','Beban Jasa Medik Dokter Operasi Ralan','"+rs.getDouble("operasiralan")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+rs.getDouble("operasiralan")+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Operasi_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Operasi_Ralan+"','Utang Jasa Medik Dokter Operasi Ralan','0','"+rs.getDouble("operasiralan")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+rs.getDouble("operasiralan")+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Operasi_Ralan+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("operasiranap")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Beban_Jasa_Medik_Dokter_Operasi_Ranap+"','Beban Jasa Medik Dokter Operasi Ranap','"+rs.getDouble("operasiranap")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+rs.getDouble("operasiranap")+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Operasi_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+Utang_Jasa_Medik_Dokter_Operasi_Ranap+"','Utang Jasa Medik Dokter Operasi Ranap','0','"+rs.getDouble("operasiranap")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+rs.getDouble("operasiranap")+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Operasi_Ranap+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
                                if(rs.getDouble("besar_bayar")>0){
                                    Sequel.menyimpan("tampjurnal_smc","'"+Bayar_JM_Dokter+"','Bayar JM Dokter','0','"+rs.getDouble("besar_bayar")+"', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","kredit=kredit+'"+(rs.getDouble("besar_bayar"))+"'","kd_rek='"+Bayar_JM_Dokter+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                    Sequel.menyimpan("tampjurnal_smc","'"+koderekening+"','"+rs.getString("nama_bayar")+"','"+rs.getDouble("besar_bayar")+"','0', '" + akses.getkode() + "', '" + akses.getalamatip() + "'","debet=debet+'"+(rs.getDouble("besar_bayar"))+"'","kd_rek='"+koderekening+"' and user_id = '" + akses.getkode() + "' and ip = '" + akses.getalamatip() + "'");
                                }
