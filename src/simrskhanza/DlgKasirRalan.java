...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnTampilkan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTampilkan.setText("Tampilkan");
        MnTampilkan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTampilkan.setName("MnTampilkan"); // NOI18N
        ...
        ppTampilkanSeleksiBPJS.setBackground(new java.awt.Color(255, 255, 254));
        ppTampilkanSeleksiBPJS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppTampilkanSeleksiBPJS.setForeground(new java.awt.Color(50, 50, 50));
        ppTampilkanSeleksiBPJS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppTampilkanSeleksiBPJS.setText("BPJS Kesehatan");
        ppTampilkanSeleksiBPJS.setName("ppTampilkanSeleksiBPJS"); // NOI18N
        ppTampilkanSeleksiBPJS.setPreferredSize(new java.awt.Dimension(200, 26));
        ppTampilkanSeleksiBPJS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppTampilkanSeleksiBPJSActionPerformed(evt);
            }
        });
        ...
        ppTampilkanSeleksiPribadi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppTampilkanSeleksiPribadi.setText("Pribadi/Umum");
        ppTampilkanSeleksiPribadi.setName("ppTampilkanSeleksiPribadi"); // NOI18N
        ppTampilkanSeleksiPribadi.setPreferredSize(new java.awt.Dimension(200, 26));
        ppTampilkanSeleksiPribadi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppTampilkanSeleksiPribadiActionPerformed(evt);
            }
        });
        ...
        ppTampilkanSeleksi.setText("Pilih Jenis Bayar/Asuransi");
        ...
        MnTampilkan.add(MnTampilkanJenisBayar);
        ...
        MnTampilkan.add(ppTampilkanBelumDiagnosa);

        jPopupMenu1.add(MnTampilkan);
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void ppRiwayatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayatBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            resume.setNoRm(TNoRw.getText(), TNoRMCari.getText(),TPasienCari.getText());
    ...
    private void ppRiwayat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayat1ActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMRiwayatPerawatan resume=new RMRiwayatPerawatan(null,true);
                resume.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),2).toString(),tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),3).toString());
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
...
//            TNoRM.requestFocus();
    ...
    private void MnHasilPemeriksaanUSGActionPerformed(java.awt.event.ActionEvent evt) {
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnHasilPemeriksaanUSGGynecologiActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnHasilEndoskopiFaringLaringActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnHasilEndoskopiTelingaActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnCatatanKeseimbanganCairanActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnCatatanObservasiInduksiPersalinanActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnDataOperasiActionPerformed(java.awt.event.ActionEvent evt) {
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                //form.emptTeks();      
                form.setPasien(TNoRw.getText(),Valid.SetTgl2(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),12).toString()));
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnDataKonsultasiMedikActionPerformed(java.awt.event.ActionEvent evt) {
        if(tabModekasir2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
    ...
    */
    ...
    private javax.swing.JMenuItem MnPenilaianPreInduksi,
                                  MnHasilPemeriksaanUSG,
                                  MnHasilPemeriksaanUSGUrologi,
                                  ...
                                  MnDataOperasi,
                                  MnDataKonsultasiMedik,
                                  MnSkriningMerokokUsiaSekolahRemaja,
                                  MnSkriningKekerasanPadaWanita,
                                  MnSkriningObesitas,
                                  MnSkriningRisikoKankerPayudara,MnSkriningRisikoKankerParu,
                                  MnSkriningKesehatanGigiMulutRemaja,MnSkriningTBC,MnCatatanAnastesiSedasi,MnSkriningPUMA;
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "+
                "reg_periksa.tgl_registrasi between ? and ? and reg_periksa.status_lanjut='Ralan' "+tampildiagnosa+ perJenisAsuransi +
    ...
    public void isCek(){
        ...
        MnPenilaianAwalMedisRalanHemodialisa.setEnabled(akses.getpenilaian_medis_hemodialisa());
            ...
            try {
                ...
                if(sukses==true){
                    ...
                    if(ttlpendapatan>0){
                        ...
                        Sequel.insertOrUpdateTampJurnal(Tindakan_Ralan, "Pendapatan Tindakan Rawat Jalan", 0, ttlpendapatan);
                    }
                    if(ttljmdokter>0){
                        Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Dokter_Tindakan_Ralan, "Beban Jasa Medik Dokter Tindakan Ralan", ttljmdokter, 0);
                        Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Dokter_Tindakan_Ralan, "Utang Jasa Medik Dokter Tindakan Ralan", 0, ttljmdokter);
                    }
                    if(ttljmperawat>0){
                        Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Paramedis_Tindakan_Ralan, "Beban Jasa Medik Paramedis Tindakan Ralan", ttljmperawat, 0);
                        Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Paramedis_Tindakan_Ralan, "Utang Jasa Medik Paramedis Tindakan Ralan", 0, ttljmperawat);
                    }
                    if(ttlkso>0){
                        Sequel.insertOrUpdateTampJurnal(Beban_KSO_Tindakan_Ralan, "Beban KSO Tindakan Ralan", ttlkso, 0);
                        Sequel.insertOrUpdateTampJurnal(Utang_KSO_Tindakan_Ralan, "Utang KSO Tindakan Ralan", 0, ttlkso);
                    }
                    if(ttljasasarana>0){
                        Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Sarana_Tindakan_Ralan, "Beban Jasa Sarana Tindakan Ralan", ttljasasarana, 0);
                        Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Sarana_Tindakan_Ralan, "Utang Jasa Sarana Tindakan Ralan", 0, ttljasasarana);
                    }
                    if(ttlbhp>0){
                        Sequel.insertOrUpdateTampJurnal(HPP_BHP_Tindakan_Ralan, "HPP BHP Tindakan Ralan", ttlbhp, 0);
                        Sequel.insertOrUpdateTampJurnal(Persediaan_BHP_Tindakan_Ralan, "Persediaan BHP Tindakan Ralan", 0, ttlbhp);
                    }
                    if(ttlmenejemen>0){
                        Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Menejemen_Tindakan_Ralan, "Beban Jasa Menejemen Tindakan Ralan", ttlmenejemen, 0);
                        Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Menejemen_Tindakan_Ralan, "Utang Jasa Menejemen Tindakan Ralan", 0, ttlmenejemen);
                    }
    ...
    private void initKasirRalan() {
        ...
        MnHasilPemeriksaanUSG.setFont(new java.awt.Font("Tahoma", 0, 11));
        MnHasilPemeriksaanUSG.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilPemeriksaanUSG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png")));
        ...
        MnHasilPemeriksaanUSG.setName("MnHasilPemeriksaanUSG");
        MnHasilPemeriksaanUSG.setPreferredSize(new java.awt.Dimension(200, 26));
        MnHasilPemeriksaanUSG.addActionListener(this::MnHasilPemeriksaanUSGActionPerformed);
        ...
        MnHasilPemeriksaanUSGNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnHasilPemeriksaanUSGNeonatus.setText("Hasil USG Neonatus");
        MnHasilPemeriksaanUSGNeonatus.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilPemeriksaanUSGNeonatus.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        MnHasilPemeriksaanUSGGynecologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnHasilPemeriksaanUSGGynecologi.setText("Hasil USG Gynecologi");
        MnHasilPemeriksaanUSGGynecologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilPemeriksaanUSGGynecologi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilPemeriksaanUSGGynecologi.setName("MnHasilPemeriksaanUSGGynecologi");
        MnHasilPemeriksaanUSGGynecologi.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        MnHasilEndoskopiFaringLaring.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnHasilEndoskopiFaringLaring.setText("Hasil Endoskopi Faring/Laring");
        MnHasilEndoskopiFaringLaring.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilEndoskopiFaringLaring.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilEndoskopiFaringLaring.setName("MnHasilEndoskopiFaringLaring");
        ...
        MnHasilEndoskopiHidung.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnHasilEndoskopiHidung.setText("Hasil Endoskopi Hidung");
        MnHasilEndoskopiHidung.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilEndoskopiHidung.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilEndoskopiHidung.setName("MnHasilEndoskopiHidung");
        ...
        MnHasilEndoskopiTelinga.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnHasilEndoskopiTelinga.setText("Hasil Endoskopi Telinga");
        MnHasilEndoskopiTelinga.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilEndoskopiTelinga.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilEndoskopiTelinga.setName("MnHasilEndoskopiTelinga");
        ...
        MnDataKonsultasiMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); 
        MnDataKonsultasiMedik.setText("Data Konsultasi Medik");
        MnDataKonsultasiMedik.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnDataKonsultasiMedik.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnDataKonsultasiMedik.setName("MnDataKonsultasiMedik");
        ...
        MnRMRawatJalan.add(MnAwalKeperawatan);
        MnRMRawatJalan.add(MnAwalMedis);
        MnRMRawatJalan.add(MnHasilUSG);
        MnRMRawatJalan.add(MnHasilEndoskopi);
        MnHasilUSG.add(MnHasilPemeriksaanUSG);
        ...
        MnHasilEndoskopi.add(MnHasilEndoskopiFaringLaring);
        MnHasilEndoskopi.add(MnHasilEndoskopiHidung);
        MnHasilEndoskopi.add(MnHasilEndoskopiTelinga);
        MnRMRawatJalan.add(MnDokumentasiTindakanESWL);
        MnRMRawatJalan.add(MnPenilaianFisioterapi);
        MnRMRawatJalan.add(MnPenilaianPsikolog);
        MnRMRawatJalan.add(MnPenilaianTerapiWicara);
