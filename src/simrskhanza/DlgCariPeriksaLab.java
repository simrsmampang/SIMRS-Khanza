...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLabSMCParagraf = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLab22Adamlabs = new javax.swing.JMenuItem();
        MnPDFLab = new javax.swing.JMenu();
        MnPDFHasilLabSMCParagraf = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLabSMCParagraf.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabSMCParagraf.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLabSMCParagraf.setForeground(new java.awt.Color(50, 50, 50));
        ...
        MnCetakLab.add(MnCetakHasilLabSMCParagraf);
        ...
        MnCetakHasilLab22Adamlabs.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLab22Adamlabs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLab22Adamlabs.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLab22Adamlabs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLab22Adamlabs.setText("Model 12 Bridging Adamlabs");
        MnCetakHasilLab22Adamlabs.setName("MnCetakHasilLab22Adamlabs"); // NOI18N
        MnCetakHasilLab22Adamlabs.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilLab22Adamlabs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLab22AdamlabsActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilLab22Adamlabs);
        ...
        MnPDFHasilLabSMCParagraf.setBackground(new java.awt.Color(255, 255, 254));
        MnPDFHasilLabSMCParagraf.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPDFHasilLabSMCParagraf.setForeground(new java.awt.Color(50, 50, 50));
        MnPDFHasilLabSMCParagraf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPDFHasilLabSMCParagraf.setText("Model Paragraf");
        MnPDFHasilLabSMCParagraf.setName("MnPDFHasilLabSMCParagraf"); // NOI18N
        MnPDFHasilLabSMCParagraf.setPreferredSize(new java.awt.Dimension(100, 26));
        MnPDFHasilLabSMCParagraf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPDFHasilLabSMCParagrafActionPerformed(evt);
            }
        });
        MnPDFLab.add(MnPDFHasilLabSMCParagraf);
                    ...
                    try{
                        ...
                        if(sukses==true){
                            if(status.equals("Ranap")){
                                ...
                                if(ttlpendapatan>0){
                                    Sequel.insertOrUpdateTampJurnal(Suspen_Piutang_Laborat_Ranap, "Suspen Piutang Laborat Ranap", 0, ttlpendapatan);
                                    Sequel.insertOrUpdateTampJurnal(Laborat_Ranap, "Pendapatan Laborat Rawat Inap", ttlpendapatan, 0);
                                }
                                if(ttljmdokter>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Dokter_Laborat_Ranap, "Beban Jasa Medik Dokter Laborat Ranap", 0, ttljmdokter);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Dokter_Laborat_Ranap, "Utang Jasa Medik Dokter Laborat Ranap", ttljmdokter, 0);
                                }
                                if(ttljmpetugas>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Petugas_Laborat_Ranap, "Beban Jasa Medik Petugas Laborat Ranap", 0, ttljmpetugas);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Petugas_Laborat_Ranap, "Utang Jasa Medik Petugas Laborat Ranap", ttljmpetugas, 0);
                                }
                                if(ttlbhp>0){
                                    Sequel.insertOrUpdateTampJurnal(HPP_Persediaan_Laborat_Rawat_Inap, "HPP Persediaan Laborat Rawat Inap", 0, ttlbhp);
                                    Sequel.insertOrUpdateTampJurnal(Persediaan_BHP_Laborat_Rawat_Inap, "Persediaan BHP Laborat Rawat Inap", ttlbhp, 0);
                                }
                                if(ttlkso>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_KSO_Laborat_Ranap, "Beban KSO Laborat Ranap", 0, ttlkso);
                                    Sequel.insertOrUpdateTampJurnal(Utang_KSO_Laborat_Ranap, "Utang KSO Laborat Ranap", ttlkso, 0);
                                }
                                if(ttljasasarana>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Sarana_Laborat_Ranap, "Beban Jasa Sarana Laborat Ranap", 0, ttljasasarana);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Sarana_Laborat_Ranap, "Utang Jasa Sarana Laborat Ranap", ttljasasarana, 0);
                                }
                                if(ttljmperujuk>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Perujuk_Laborat_Ranap, "Beban Jasa Perujuk Laborat Ranap", 0, ttljmperujuk);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Perujuk_Laborat_Ranap, "Utang Jasa Perujuk Laborat Ranap", ttljmperujuk, 0);
                                }
                                if(ttlmenejemen>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Menejemen_Laborat_Ranap, "Beban Jasa Menejemen Laborat Ranap", 0, ttlmenejemen);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Menejemen_Laborat_Ranap, "Utang Jasa Menejemen Laborat Ranap", ttlmenejemen, 0);
                                }
                                ...
                                Sequel.deleteTampJurnal();    
                                if(ttlpendapatan>0){
                                    Sequel.insertOrUpdateTampJurnal(Suspen_Piutang_Laborat_Ralan, "Suspen Piutang Laborat Ralan", 0, ttlpendapatan);
                                    Sequel.insertOrUpdateTampJurnal(Laborat_Ralan, "Pendapatan Laborat Rawat Jalan", ttlpendapatan, 0);
                                }
                                if(ttljmdokter>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Dokter_Laborat_Ralan, "Beban Jasa Medik Dokter Laborat Ralan", 0, ttljmdokter);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Dokter_Laborat_Ralan, "Utang Jasa Medik Dokter Laborat Ralan", ttljmdokter, 0);
                                }
                                if(ttljmpetugas>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Petugas_Laborat_Ralan, "Beban Jasa Medik Petugas Laborat Ralan", 0, ttljmpetugas);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Petugas_Laborat_Ralan, "Utang Jasa Medik Petugas Laborat Ralan", ttljmpetugas, 0);
                                }
                                if(ttlbhp>0){
                                    Sequel.insertOrUpdateTampJurnal(HPP_Persediaan_Laborat_Rawat_Jalan, "HPP Persediaan Laborat Rawat Jalan", 0, ttlbhp);
                                    Sequel.insertOrUpdateTampJurnal(Persediaan_BHP_Laborat_Rawat_Jalan, "Persediaan BHP Laborat Rawat Jalan", ttlbhp, 0);
                                }
                                if(ttlkso>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_KSO_Laborat_Ralan, "Beban KSO Laborat Ralan", 0, ttlkso);
                                    Sequel.insertOrUpdateTampJurnal(Utang_KSO_Laborat_Ralan, "Utang KSO Laborat Ralan", ttlkso, 0);
                                }
                                if(ttljasasarana>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Sarana_Laborat_Ralan, "Beban Jasa Sarana Laborat Ralan", 0, ttljasasarana);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Sarana_Laborat_Ralan, "Utang Jasa Sarana Laborat Ralan", ttljasasarana, 0);
                                }
                                if(ttljmperujuk>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Perujuk_Laborat_Ralan, "Beban Jasa Perujuk Laborat Ralan", 0, ttljmperujuk);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Perujuk_Laborat_Ralan, "Utang Jasa Perujuk Laborat Ralan", ttljmperujuk, 0);
                                }
                                if(ttlmenejemen>0){
                                    Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Menejemen_Laborat_Ralan, "Beban Jasa Menejemen Laborat Ralan", 0, ttlmenejemen);
                                    Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Menejemen_Laborat_Ralan, "Utang Jasa Menejemen Laborat Ralan", ttlmenejemen, 0);
                                }
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            i=0;
                            while(rs2.next()){
                                Sequel.menyimpan("temporary_lab","'"+i+"','"+rs2.getString("nm_perawatan")+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Data User"); 
                                i++;
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        Sequel.menyimpan("temporary_lab","'"+i+"','  "+rs3.getString("Pemeriksaan")+"','"+rs3.getString("nilai").replaceAll("'","`")+"','"+rs3.getString("satuan")
                                                +"','"+rs3.getString("nilai_rujukan")+"','"+rs3.getString("keterangan")+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Data User"); 
                                        i++;
                                    }
                                } catch (Exception e) {
                    ...
                    if(rs.next()){
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                ttl=ttl+item;                    
                                Sequel.menyimpan("temporary_lab","'"+i+"','"+rs2.getString("kd_jenis_prw")+"','"+rs2.getString("nm_perawatan")+"','"+item+"','Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");                        
                                i++;
                                ps3=koneksi.prepareStatement(
                                    "select template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai,template_laboratorium.satuan,detail_periksa_lab.nilai_rujukan,detail_periksa_lab.biaya_item,"+
                                    "detail_periksa_lab.keterangan,detail_periksa_lab.kd_jenis_prw from detail_periksa_lab inner join template_laboratorium on detail_periksa_lab.id_template=template_laboratorium.id_template "+
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        ...
                                        ttl=ttl+item; 
                                        Sequel.menyimpan("temporary_lab","'"+i+"','"+rs3.getString("kd_jenis_prw")+"','   "+rs3.getString("Pemeriksaan")+"','"+item+"','Detail Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");                        
                                        i++;
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif ps3 : "+e);
                        ...
                        Sequel.menyimpan("temporary_lab","'"+i+"','','Total Biaya Pemeriksaan Lab','"+ttl+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getkode()+"','"+akses.getalamatip()+"'","Transaksi Biaya Lab");
                        i++;
    ...
    private void MnCetakHasilLabSMCParagrafActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabSMCParagrafActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
            ...
            String sql = "select jns_perawatan_lab.nm_perawatan, template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai from detail_periksa_lab " +
                "join template_laboratorium on detail_periksa_lab.id_template = template_laboratorium.id_template  " +
                "join jns_perawatan_lab on detail_periksa_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw  " +
                "where detail_periksa_lab.no_rawat = ? and detail_periksa_lab.tgl_periksa = ? and detail_periksa_lab.jam = ? " +
                "order by jns_perawatan_lab.kd_jenis_prw asc, template_laboratorium.urut asc";
            try {
                ps4 = koneksi.prepareStatement(
                    "select periksa_lab.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien, pasien.jk, pasien.umur, petugas.nama, " +
                    "date_format(periksa_lab.tgl_periksa, '%d-%m-%Y') as tgl_periksa, periksa_lab.jam, periksa_lab.nip, periksa_lab.dokter_perujuk, " +
                    "periksa_lab.kd_dokter, concat_ws(', ', pasien.alamat, kelurahan.nm_kel, kecamatan.nm_kec, kabupaten.nm_kab) as alamat, dokter.nm_dokter, " +
                    "date_format(pasien.tgl_lahir, '%d-%m-%Y') as lahir from periksa_lab join reg_periksa on periksa_lab.no_rawat = reg_periksa.no_rawat " +
                    "join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join petugas on periksa_lab.nip = petugas.nip join dokter " +
                    "on periksa_lab.kd_dokter = dokter.kd_dokter join kelurahan on pasien.kd_kel = kelurahan.kd_kel join kecamatan " +
                    "on pasien.kd_kec = kecamatan.kd_kec join kabupaten on pasien.kd_kab = kabupaten.kd_kab where periksa_lab.kategori = 'PK' " +
                    "and periksa_lab.no_rawat = ? and periksa_lab.tgl_periksa = ? and periksa_lab.jam = ? " +
                    "group by concat(periksa_lab.no_rawat, periksa_lab.tgl_periksa, periksa_lab.jam)"
                );
                try {
                    ps4.setString(1, tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                    ps4.setString(2, tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).toString());
                    ps4.setString(3, tbDokter.getValueAt(tbDokter.getSelectedRow(), 4).toString());
                    rs = ps4.executeQuery();
                    while (rs.next()) {
                        kamar = Sequel.cariIsi("select ifnull(kamar_inap.kd_kamar,'') from kamar_inap where kamar_inap.no_rawat='" + rs.getString("no_rawat") + "' order by kamar_inap.tgl_masuk desc,kamar_inap.jam_masuk desc limit 1");
                        if (!kamar.equals("")) {
                        ...
                        Map<String, Object> param = new HashMap<>();
                        param.put("noperiksa", rs.getString("no_rawat"));
                        param.put("tgl_periksa", Valid.SetTgl(rs.getString("tgl_periksa")));
                        param.put("tanggal", rs.getString("tgl_periksa"));
                        param.put("jam", rs.getString("jam"));
                        param.put("norm", rs.getString("no_rkm_medis"));
                        param.put("namapasien", rs.getString("nm_pasien"));
                        ...
                        param.put("umur", rs.getString("umur"));
                        param.put("lahir", rs.getString("lahir"));
                        param.put("pengirim", Sequel.cariIsiSmc("select nm_dokter from dokter where kd_dokter = ?", rs.getString("dokter_perujuk")));
                        param.put("penjab", rs.getString("nm_dokter"));
                        param.put("petugas", rs.getString("nama"));
                        param.put("alamat", rs.getString("alamat"));
                        param.put("kamar", kamar);
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.reportSmc("rptPeriksaLab13Permintaan.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            } else {
                                Valid.reportSmc("rptPeriksaLab13.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : " + e);
                        } finally {
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabSMCParagrafActionPerformed

    private void MnPDFHasilLabSMCParagrafActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPDFHasilLabSMCParagrafActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLab13Permintaan.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            } else {
                                Valid.MyReport("rptPeriksaLab13.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : " + e);
                        } finally {
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnPDFHasilLabSMCParagrafActionPerformed

    private void MnCetakHasilLab22AdamlabsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLab22AdamlabsActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                param.put("klinis",rspermintaan.getString("diagnosa_klinis"));
                                Valid.MyReport("rptPeriksaLab12AdamlabsPermintaan.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLab12Adamlabs.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLab22AdamlabsActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilLab22Adamlabs;
    ...
    private javax.swing.JMenuItem MnCetakHasilLabSMCParagraf;
    ...
    private javax.swing.JMenuItem MnPDFHasilLabSMCParagraf;
