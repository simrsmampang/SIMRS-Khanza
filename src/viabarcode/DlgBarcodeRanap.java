...
public final class DlgBarcodeRanap extends javax.swing.JDialog {
    ...
    */
    ...
    public void setNoRm(String norwt) {
        ...
        lokasistok=Sequel.cariIsi("select set_depo_ranap.kd_depo from set_depo_ranap where set_depo_ranap.kd_bangsal=?",Sequel.cariIsi("select kd_bangsal from kamar where kd_kamar=?",this.kd_bangsal));
