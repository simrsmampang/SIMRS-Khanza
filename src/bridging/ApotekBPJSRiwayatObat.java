 ...
 * @author dosen
 */
public final class ApotekBPJSRiwayatObat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public ApotekBPJSRiwayatObat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"No SEP","No Resep","Kode Obat","Nama Obat","Jumlah","Signa 1","Signa 2","Jenis Obat"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSRiwayatObat dialog = new ApotekBPJSRiwayatObat(new javax.swing.JFrame(), true);
