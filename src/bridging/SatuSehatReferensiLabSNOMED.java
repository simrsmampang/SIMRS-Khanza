 ...
 * @author dosen
 */
public final class SatuSehatReferensiLabSNOMED extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatReferensiLabSNOMED(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Satu Sehat Referensi Laboratorium SNOMED-CT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatReferensiLabSNOMED dialog = new SatuSehatReferensiLabSNOMED(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        if (Valid.daysOld("./cache/satusehatreferensilabsnomed.iyem") > 30) {
            tampil2();
        }
        Valid.tabelKosong(tabMode);
        
        try (FileReader fr = new FileReader("./cache/satusehatreferensilabsnomed.iyem")) {
    ...
    public void tampil2() {
        try (ResultSet rs = koneksi.createStatement().executeQuery("select * from satu_sehat_referensi_lab_snomed")) {
            File file = new File("./cache/satusehatreferensilabsnomed.iyem");
            file.createNewFile();
            String iyem = "";
