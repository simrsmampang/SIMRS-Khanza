...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            validasi_pengajuan_biaya=false,pemeriksaan_fisik_ralan_per_penyakit=false,penilaian_lanjutan_resiko_jatuh_geriatri=false;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.validasi_pengajuan_biaya=true;
                        ...
                        akses.validasi_pengajuan_biaya=rs2.getBoolean("validasi_pengajuan_biaya");
                        ...
                        akses.validasi_pengajuan_biaya=false;
    ...
    public static boolean getvalidasi_pengajuan_biaya(){return akses.validasi_pengajuan_biaya;}
