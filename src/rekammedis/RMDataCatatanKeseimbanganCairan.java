...
public final class RMDataCatatanKeseimbanganCairan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.add(Minum);
        Minum.setBounds(337, 90, 50, 23);

        jLabel20.setText("Minum (ml) :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(263, 90, 70, 23);

        jLabel23.setText("Tranfusi (ml) :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(125, 90, 80, 23);
        ...
        Tranfusi.setBounds(209, 90, 50, 23);
        ...
        jLabel22.setBounds(696, 90, 90, 23);
        ...
        FormInput.add(Drain);
        Drain.setBounds(642, 90, 50, 23);

        jLabel24.setText("Drain (ml) :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(568, 90, 70, 23);
        ...
        jLabel26.setBounds(844, 90, 60, 23);
        ...
        Keseimbangan.setBounds(149, 120, 50, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Keseimbangan Cairan (ml) :");
        jLabel27.setName("jLabel27"); // NOI18N
        jLabel27.setVerifyInputWhenFocusTarget(false);
        FormInput.add(jLabel27);
        jLabel27.setBounds(14, 120, 131, 23);

        jLabel29.setText("Keterangan :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(388, 120, 100, 23);
        ...
        Keterangan.setBounds(492, 120, 466, 23);
