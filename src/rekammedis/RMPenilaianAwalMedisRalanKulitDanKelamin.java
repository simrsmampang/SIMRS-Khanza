...
public final class RMPenilaianAwalMedisRalanKulitDanKelamin extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanKulitDanKelamin(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Riwayat Penggunakan Obat","Riwayat Penyakit Keluarga","Kesadaran","Status Nutrisi","TD(mmHg)","Nadi(x/menit)","Suhu","RR(x/menit)","BB(Kg)","Nyeri","GCS","Status Dermatovenereologis","Pemeriksaan","Diagnosis","Diagnosis Banding","Permasalahan","Terapi","Tindakan","Edukasi"
        }){
        ...
        RPK.setDocument(new batasInput((int)50).getKata(RPK));
        ...
        Nyeri.setDocument(new batasInput((byte)30).getKata(Nyeri));
        ...
        //Tindakan1.setDocument(new batasInput((byte)500).getKata(Tindakan1));
    ...
    private void initComponents() {
        ...
        Statusderma = new java.awt.TextArea();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Kulit dan Kelamin ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.add(BB);
        BB.setBounds(305, 290, 50, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(360, 290, 30, 23);
        ...
        jLabel37.setBounds(20, 190, 150, 23);
        ...
        jLabel94.setText("STATUS DERMATOVENEREOLOGIS :");
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(480, 350, 200, 23);
        ...
        jSeparator13.setBounds(0, 566, 880, 3);
        ...
        scrollPane12.setBounds(30, 700, 380, 43);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("Diagnosis Banding :");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(30, 600, 190, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-07-2023 13:47:24" }));
        ...
        jLabel105.setBounds(30, 680, 190, 23);
        ...
        jLabel109.setBounds(30, 840, 190, 23);
        ...
        scrollPane18.setBounds(30, 860, 380, 43);
        ...
        scrollPane13.setBounds(30, 620, 380, 43);
        ...
        jSeparator15.setBounds(0, 911, 880, 3);
        ...
        scrollPane5.setBounds(180, 190, 260, 42);
        ...
        PanelWall1.setBounds(30, 350, 440, 200);

        Statusderma.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Statusderma.setForeground(new java.awt.Color(50, 50, 50));
        Statusderma.setName("Statusderma"); // NOI18N
        FormInput.add(Statusderma);
        Statusderma.setBounds(480, 380, 380, 100);
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='120px'><b>Riwayat Riwayat Penyakit Keluarga</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>Statusderma</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("statusderma")+"</td>"+
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanKulitdankelamin.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Neurologi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_kulitdankelamin.tanggal,"+
                "penilaian_medis_ralan_kulitdankelamin.kd_dokter,penilaian_medis_ralan_kulitdankelamin.anamnesis,penilaian_medis_ralan_kulitdankelamin.hubungan,penilaian_medis_ralan_kulitdankelamin.keluhan_utama,penilaian_medis_ralan_kulitdankelamin.rps,penilaian_medis_ralan_kulitdankelamin.rpd,penilaian_medis_ralan_kulitdankelamin.rpo,penilaian_medis_ralan_kulitdankelamin.rpk,"+
                "penilaian_medis_ralan_kulitdankelamin.kesadaran,penilaian_medis_ralan_kulitdankelamin.status,penilaian_medis_ralan_kulitdankelamin.td,penilaian_medis_ralan_kulitdankelamin.nadi,penilaian_medis_ralan_kulitdankelamin.suhu,penilaian_medis_ralan_kulitdankelamin.rr,penilaian_medis_ralan_kulitdankelamin.bb,penilaian_medis_ralan_kulitdankelamin.nyeri,penilaian_medis_ralan_kulitdankelamin.gcs,"+
                "penilaian_medis_ralan_kulitdankelamin.statusderma,penilaian_medis_ralan_kulitdankelamin.pemeriksaan,penilaian_medis_ralan_kulitdankelamin.diagnosis,penilaian_medis_ralan_kulitdankelamin.diagnosis2,penilaian_medis_ralan_kulitdankelamin.permasalahan,penilaian_medis_ralan_kulitdankelamin.terapi,penilaian_medis_ralan_kulitdankelamin.tindakan,penilaian_medis_ralan_kulitdankelamin.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ralan_kulitdankelamin on reg_periksa.no_rawat=penilaian_medis_ralan_kulitdankelamin.no_rawat "+
                "inner join dokter on penilaian_medis_ralan_kulitdankelamin.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_kulitdankelamin.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    ...
    private java.awt.TextArea Statusderma;
