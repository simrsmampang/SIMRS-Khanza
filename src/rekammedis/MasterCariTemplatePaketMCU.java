 ...
 * @author dosen
 */
public final class MasterCariTemplatePaketMCU extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MasterCariTemplatePaketMCU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                if (Sequel.menyimpantf2("pemeriksaan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, new String[] {
                    ...
                    if (TabModeTindakan.getRowCount() > 0) {
                        ...
                        if (sukses == true) {
                            ...
                            if (ttlmenejemen > 0) {
                                Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Menejemen_Tindakan_Ralan, "Beban Jasa Manajemen Tindakan Ralan", ttlmenejemen, 0);
                                Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Menejemen_Tindakan_Ralan, "Utang Jasa Manajemen Tindakan Ralan", 0, ttlmenejemen);
                            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterCariTemplatePaketMCU dialog = new MasterCariTemplatePaketMCU(new javax.swing.JFrame(), true);
