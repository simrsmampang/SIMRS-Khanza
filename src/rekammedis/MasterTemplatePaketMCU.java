...
public class MasterTemplatePaketMCU extends javax.swing.JDialog {
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){        
                     ...
                     Nama.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(),1).toString());
                }  
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        }else if(KdDokter.getText().trim().equals("")||Nama.getText().trim().equals("")){
        ...
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("template_pemeriksaan_dokter","?,?,?,?,?,?,?,?","No.Template",8,new String[]{
                ...
                tabMode.addRow(new String[]{
                    Kd.getText(),KdDokter.getText(),Nama.getText(),Subjek.getText(),Objek.getText(),Plan.getText(),Instruksi.getText(),Evaluasi.getText()
                });
                emptTeks();
            }                
        }
    ...
    */
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            Nama.setText(dokter.tampil3(KdDokter.getText()));
                                ...
                                "<tr class='isi'>"+
                                    "<td valign='top' align='left' width='100%'>"+
                                        ...
                                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                            "<tr class='isi'>"+
                                                "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%'>Kode Penyakit</td>"+
                                                "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80%'>Nama Penyakit</td>"+
                                            "</tr>"
                            );
                            Valid.tabelKosong(tabModeDiagnosa);
                            rs.beforeFirst();
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    "<td valign='top' align='left' width='100%'>"+
                                        ...
                                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                            "<tr class='isi'>"+
                                                "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%'>Kode Prosedur</td>"+
                                                "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80%'>Nama Prosedur</td>"+
                                            "</tr>"
                            );
                            Valid.tabelKosong(tabModeProsedur);
                            rs.beforeFirst();
    ...
    private void ganti(){
        if(Sequel.queryu2tf("delete from template_pemeriksaan_dokter where no_template=?",1,new String[]{
            ...
            if(Sequel.menyimpantf("template_pemeriksaan_dokter","?,?,?,?,?,?,?,?","No.Template",8,new String[]{
                ...
                tabMode.addRow(new String[]{
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),KdDokter.getText(),Nama.getText(),Subjek.getText(),Objek.getText(),Asesmen.getText(),Plan.getText(),Instruksi.getText(),Evaluasi.getText()
                });
